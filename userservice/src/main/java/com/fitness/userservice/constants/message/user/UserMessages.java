package com.fitness.userservice.constants.message.user;

import com.fitness.userservice.constants.message.common.CommonMessages;
...
public final class UserMessages {
    ...
    public static final String USER_EXISTS = BASE_NAME + " " + CommonMessages.EXISTS;
